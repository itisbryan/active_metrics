  ...
  module Models
    class GrapeRecord < BaseRecord
      attr_accessor :datetime, :datetimei, :format, :status, :path, :method, :request_id, :json,
                    :endpoint_render_grape, :endpoint_run_grape, :format_response_grape
      ...
      def initialize(request_id:, datetime: nil, datetimei: nil, format: nil, path: nil, status: nil, method: nil,
                     endpoint_render_grape: nil, endpoint_run_grape: nil, format_response_grape: nil, json: '{}')
        @datetime = datetime
      ...
      def save
        ...
        value = { 'endpoint_render.grape' => endpoint_render_grape, 'endpoint_run.grape' => endpoint_run_grape,
