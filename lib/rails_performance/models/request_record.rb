  ...
  module Models
    class RequestRecord < BaseRecord
      attr_accessor :controller, :action, :format, :status, :datetime, :datetimei, :method, :path, :request_id, :json,
                    :view_runtime, :db_runtime, :duration, :http_referer, :custom_data, :exception, :exception_object
      ...
      def initialize(controller:, action:, format:, status:, datetime:, datetimei:, method:, path:, request_id:,
                     view_runtime: nil, db_runtime: nil, duration: nil, http_referer: nil, custom_data: nil, exception: nil, exception_object: nil, json: '{}')
      ...
      def record_hash
        {
          ...
          h.merge!(custom_data) if custom_data.is_a?(Hash)
        end
      end
