...
def dummy_sidekiq_event(worker: 'Worker', queue: 'default', jid: "jxzet-#{RailsPerformance::Utils.time.to_i}",
                        datetimei: RailsPerformance::Utils.time.to_i, enqueued_ati: RailsPerformance::Utils.time.to_i, start_timei: RailsPerformance::Utils.time.to_i, duration: rand(60), status: 'success')
...
def dummy_grape_record(datetimei: RailsPerformance::Utils.time.to_i, status: 200, format: 'json', method: 'GET',
                       path: '/api/users', request_id: SecureRandom.hex(16))
...
def dummy_rake_record(datetimei: RailsPerformance::Utils.time.to_i, status: 'success',
...
def dummy_delayed_job_record(datetimei: RailsPerformance::Utils.time.to_i, status: 'success',
